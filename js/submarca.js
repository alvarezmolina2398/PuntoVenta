...
function insertar(nombre, marca) {
    $.ajax({
        type: 'POST',
        url: 'wssubmarcas.asmx/GuardarDatos',
        data: '{marca:'+marca+', nombre : "' + nombre + '"}',
...
function actualizar(marca, nombre, id) {
    $.ajax({
        type: 'POST',
        url: 'wssubmarcas.asmx/ActualizarDatos',
        data: '{marca: '+marca+', nombre : "' + nombre + '", id: ' + id + ' }',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
            $('#bt-guardar').removeClass('btn-info');
...
function mostrarColores() {
    ...
    $.ajax({
        type: "POST",
        url: "wssubmarcas.asmx/ObtenerDatos",
        data: '',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function getMarcas() {
  ...
  $.ajax({
      type: "POST",
      url: "wsmarcas.asmx/ObtenerDatos",
      data: '',
      contentType: "application/json; charset=utf-8",
      dataType: "json",
      success: function (msg) {
