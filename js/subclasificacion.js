$(function () {
    ...
    $(function () {
        ...
        $('.Mdnew').click(function () {
            ...
            document.getElementById('clasif').value = 0;
        });
        ...
        $('#bt-guardar').click(function () {
            ...
            if (nombre.val() != "" && marca.val() != 0) {
                ...
                $('#clasif').removeClass('is-invalid');
                $('#clasif').removeClass('is-valid');
...
function insertar(nombre, marca) {
    $.ajax({
        type: 'POST',
        url: 'wssubclasificacion.asmx/GuardarDatos',
        data: '{clasif:' + marca + ', desc : "' + nombre + '"}',
...
function actualizar(marca, nombre, id) {
    $.ajax({
        type: 'POST',
        url: 'wssubclasificacion.asmx/ActualizarDatos',
        data: '{clasif: ' + marca + ', desc : "' + nombre + '", id: ' + id + ' }',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
            $('#bt-guardar').removeClass('btn-info');
...
function eliminar(id) {
    $.ajax({
        type: 'POST',
        url: 'wssubclasificacion.asmx/Eliminar',
        data: '{id: ' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function mostrarColores() {
    ...
    $.ajax({
        type: "POST",
        url: "wssubclasificacion.asmx/ObtenerDatos",
        data: '',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function getClasificacion() {
    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            $.each(msg.d, function () {
                tds += '<option  value="' + this.id_clasif + '">' + this.id_nombre + '</option>';
