...
function insertar(nombre) {
    $.ajax({
        type: 'POST',
        url: 'wspermisoses.asmx/GuardarDatos',
        data: '{ desc : "' + nombre + '"}',
...
function actualizar(nombre, id) {
    $.ajax({
        type: 'POST',
        url: 'wspermisoses.asmx/ActualizarDatos',
        data: '{ desc : "' + nombre + '", id: ' + id + ' }',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
            $('#bt-guardar').removeClass('btn-info');
...
function eliminar(id) {
    $.ajax({
        type: 'POST',
        url: 'wspermisoses.asmx/Eliminar',
        data: '{id: ' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function mostrarMarcas() {
    ...
    $.ajax({
        type: "POST",
        url: "wspermisoses.asmx/ObtenerDatos",
        data: '',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
        ...
        success: function (msg) {
            $.each(msg.d, function () {
                ...
                tds = tds + "<button class='btn btn-sm btn-outline-info' onclick='Editar(" + this.id + ",\"" + this.desc + "\")' data-container='body' data-trigger='hover' data-toggle='popover' data-placement='bottom' data-content='Click para poder cargar los datos en el formulario, para poder actualizar.' data-original-title='' title ='' >";
