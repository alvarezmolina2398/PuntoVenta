...
function insertar(nombre) {
    $.ajax({
        type: 'POST',
        url: 'wsclasificacionproveedor.asmx/GuardarDatos',
        data: '{ nombre : "' + nombre + '"}',
...
function actualizar(nombre, id) {
    $.ajax({
        type: 'POST',
        url: 'wsclasificacionproveedor.asmx/ActualizarDatos',
...
function eliminar(id) {
    $.ajax({
        type: 'POST',
        url: 'wsclasificacionproveedor.asmx/Eliminar',
        data: '{id: ' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function mostrarColores() {
    ...
    $.ajax({
        type: "POST",
        url: "wsclasificacionproveedor.asmx/ObtenerDatos",
        data: '',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
