...
function insertar(nombre) {
    $.ajax({
        type: 'POST',
        url: 'wsclasificacionClientes.asmx/GuardarDatos',
        data: '{ nombre : "' + nombre + '"}',
...
function actualizar(nombre, id) {
    $.ajax({
        type: 'POST',
        url: 'wsclasificacionClientes.asmx/ActualizarDatos',
...
function eliminar(id) {
    $.ajax({
        type: 'POST',
        url: 'wsclasificacionClientes.asmx/Eliminar',
        data: '{id: ' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function mostrarColores() {
    ...
    $.ajax({
        type: "POST",
        url: "wsclasificacionClientes.asmx/ObtenerDatos",
        data: '',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
