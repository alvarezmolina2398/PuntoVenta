...
Public Class wsclasificacionClientes
    ...
    Public Function ObtenerDatos() As List(Of Datos)
        ...
        Dim StrEncabezado As String = "SELECT * FROM Clasificacion_Cliente WHERE estado = 1 "
    ...
    Public Function GuardarDatos(ByVal nombre As String) As Boolean
        ...
        Dim StrEncabezado As String = "INSERT INTO  Clasificacion_Cliente (Clasificacion,estado) VALUES ('" & nombre & "',1)"
    ...
    Public Function ActualizarDatos(ByVal nombre As String, ByVal id As Integer) As Boolean
        Dim result As Boolean = False
        Dim StrEncabezado As String = "UPDATE Clasificacion_Cliente SET Clasificacion = '" & nombre & "' WHERE id_clasif=" & id
        result = manipular.EjecutaTransaccion1(StrEncabezado)
        Return result
    End Function
    ...
    Public Function Eliminar(ByVal id As Integer) As Boolean
        Dim result As Boolean = False
        Dim StrEncabezado As String = "UPDATE Clasificacion_Cliente SET estado=0 WHERE id_clasif=" & id
        result = manipular.EjecutaTransaccion1(StrEncabezado)
        Return result
    End Function
