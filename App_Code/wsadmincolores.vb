...
Public Class wsadmincolores
    ...
    Public Function ObtenerDatos() As List(Of Datos)
        ...
        For i = 0 To TablaEncabezado.Rows.Count - 1
            For ii = 0 To 1
                ...
                Elemento.nombre = TablaEncabezado.Rows(i).Item("descripcionColor").ToString
                result.Add(Elemento)
                ii = ii + 1
            Next
        Next
    ...
    Public Function GuardarDatos(ByVal nombre As String) As Boolean
        ...
        Dim StrEncabezado As String = "INSERT INTO  COLOR (descripcionColor,estado) VALUES ('" & nombre & "',1)"
    ...
    Public Function ActualizarDatos(ByVal nombre As String, ByVal id As Integer) As Boolean
        Dim result As Boolean = False
        Dim StrEncabezado As String = "UPDATE COLOR SET descripcionColor = '" & nombre & "' WHERE idColor=" & id
        result = manipular.EjecutaTransaccion1(StrEncabezado)
        Return result
    End Function
    ...
    Public Function Eliminar(ByVal id As Integer) As Boolean
        Dim result As Boolean = False
        Dim StrEncabezado As String = "UPDATE COLOR SET estado=0 WHERE idColor=" & id
        result = manipular.EjecutaTransaccion1(StrEncabezado)
        Return result
    End Function
