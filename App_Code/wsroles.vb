...
Public Class wsroles
    ...
    Public Function ObtenerDatos() As List(Of Datos)
        ...
        For i = 0 To TablaEncabezado.Rows.Count - 1
            For ii = 0 To 1
                ...
                Elemento.id = TablaEncabezado.Rows(i).Item("idRole")
    ...
    Public Function GuardarDatos(ByVal nombre As String) As Boolean
        ...
        Dim StrEncabezado As String = "INSERT INTO  ENC_ROLE (descripcion,estado) VALUES ('" & nombre & "',1)"
    ...
    Public Function ActualizarDatos(ByVal nombre As String, ByVal id As Integer) As Boolean
        Dim result As Boolean = False
        Dim StrEncabezado As String = "UPDATE ENC_ROLE SET descripcion = '" & nombre & "' WHERE idRole=" & id
        result = manipular.EjecutaTransaccion1(StrEncabezado)
        Return result
    End Function
    ...
    Public Function Eliminar(ByVal id As Integer) As Boolean
        Dim result As Boolean = False
        Dim StrEncabezado As String = "UPDATE ENC_ROLE SET estado=0 WHERE idRole=" & id
        result = manipular.EjecutaTransaccion1(StrEncabezado)
        Return result
    End Function
